...
from identity.base.aries_agent import AriesAgent

sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from identity.base.support.mediator_agent import start_mediator_agent, connect_wallet_to_mediator
from identity.base.support.endorser_agent import start_endorser_agent
from identity.base.support.demo_agent import DemoAgent, default_genesis_txns

from identity.base.support.demo_agent import (
    CRED_FORMAT_INDY,
    CRED_FORMAT_JSON_LD,
    DID_METHOD_KEY,
    KEY_TYPE_BLS,
